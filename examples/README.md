...
| 示例 | 覆盖能力 |
|---|---|
| [`01-typed-platform-calls`](./01-typed-platform-calls/) | 完整协议、无泛型方法推断、部分协议额外 key 推断、`$invoke`、全平台 transport |
| [`02-events-and-callback-paths`](./02-events-and-callback-paths/) | `$on`、`$once`、全局函数、嵌套对象路径、统一入口事件 |
